...
export const projects: Project[] = [
  ...
  },
  {
    ...
    featured: false,
    oneliner: 'Hackathon voice agent built with ElevenLabs + Gemini.',
    bullets: [
      'Conversational voice agent prototyped during a hackathon, wiring ElevenLabs voice with a Gemini reasoning layer over REST APIs.',
    ],
    stack: ['REST APIs'],
  ...
  },
  {
    ...
    filters: ['Research', 'Audio / ML'],
    featured: false,
    oneliner: 'CNN-based audio genre classification.',
    bullets: [
      'Convolutional neural network trained on spectrogram features to classify music tracks by genre.',
    ],
    stack: ['Python'],
    ai: ['TensorFlow', 'Keras'],
  ...
  },
  {
    ...
    filters: ['Experiments'],
    featured: false,
    oneliner: 'Raising awareness of the eco-impact of daily actions.',
    bullets: [
      'Interactive audio-visual installation pairing real-time visuals with sound to surface the environmental cost of everyday choices.',
    ],
